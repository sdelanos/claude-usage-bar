...
struct UserFacingError: Equatable, Hashable {
    ...
    static func translate(_ error: Error) -> UserFacingError {
        ...
        default:
            assertionFailure(
                "UserFacingError.translate missing mapping for \(type(of: error)): \(error)"
            )
    ...
    private static func translate(urlError: URLError) -> UserFacingError {
        ...
        case .notConnectedToInternet,
             ...
             .dataNotAllowed:
            .init(message: "No internet connection.", isRetryable: true)
        case .timedOut,
             .cannotConnectToHost,
             .cannotFindHost,
             .dnsLookupFailed:
            .init(message: "Couldn't reach Anthropic. Try again.", isRetryable: true)
        case .cancelled:
            .init(message: "Request was cancelled.", isRetryable: true)
        case .secureConnectionFailed,
            ...
            .init(
                message: "Couldn't verify the TLS certificate for api.anthropic.com.",
                isRetryable: true
            )
        default:
            .init(message: "Network error. Try again.", isRetryable: true)
        }
    }
}
